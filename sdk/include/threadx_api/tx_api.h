...
#define THREADX_MINOR_VERSION           7
...
UINT        tx_event_flags_set(TX_EVENT_FLAGS_GROUP *group_ptr, ULONG flags_to_set, 
                    UINT set_option);
UINT        tx_event_flags_set_notify(TX_EVENT_FLAGS_GROUP *group_ptr, VOID (*events_set_notify)(TX_EVENT_FLAGS_GROUP *group_ptr));
...
UINT        tx_queue_send_notify(TX_QUEUE *queue_ptr, VOID (*queue_send_notify)(TX_QUEUE *queue_ptr));
...
UINT        tx_semaphore_put_notify(TX_SEMAPHORE *semaphore_ptr, VOID (*semaphore_put_notify)(TX_SEMAPHORE *semaphore_ptr));
...
UINT        tx_thread_entry_exit_notify(TX_THREAD *thread_ptr, VOID (*thread_entry_exit_notify)(TX_THREAD *thread_ptr, UINT type));
...
UINT        _tx_timer_create(TX_TIMER *timer_ptr, CHAR *name_ptr, 
                    VOID (*expiration_function)(ULONG expiration_input), ULONG expiration_input, ULONG initial_ticks,
