...
typedef struct TXM_MODULE_CALLBACK_STRUCT
{
    ...
    VOID                *txm_module_callback_response_handler;
    ULONG               txm_module_callback_param_3;
    ULONG               txm_module_callback_param_4;
    ULONG               txm_module_callback_param_5;
    ULONG               txm_module_callback_param_6;
    ULONG               txm_module_callback_param_7;
    ULONG               txm_module_callback_param_8;
...
#ifdef TX_DAM_QC_CUSTOMIZATIONS
	VOID                *txm_module_callback_notify_saved_app_cb;
    VOID                *txm_module_callback_notify_response_handler;
    ULONG               txm_module_callback_notify_param_3;
    ULONG               txm_module_callback_notify_param_4;
    ULONG               txm_module_callback_notify_param_5;
    ULONG               txm_module_callback_notify_param_6;
    ULONG               txm_module_callback_notify_param_7;
    ULONG               txm_module_callback_notify_param_8;
#endif // TX_DAM_QC_CUSTOMIZATIONS
