...
* @{
*/
#define PRODUCT_KEY "041c5900845c4a918342fda602864e8c"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "8625fef2eebf49939b7df089d5accf8d"
...
* @{
*/
#define Led_Value_BYTEOFFSET                    0
#define Led_Value_BITOFFSET                     0
#define Led_Value_LEN                           1
#define Motor_Value_BYTEOFFSET                    0
#define Motor_Value_BITOFFSET                     1
#define Motor_Value_LEN                           1

#define HeartRateValue_RATIO                         1
#define HeartRateValue_ADDITION                      1
#define HeartRateValue_MIN                           0
#define HeartRateValue_MAX                           199
#define X_axis_Value_RATIO                         1
#define X_axis_Value_ADDITION                      -1000
#define X_axis_Value_MIN                           0
#define X_axis_Value_MAX                           2000
#define Y_axis_Value_RATIO                         1
#define Y_axis_Value_ADDITION                      -1000
#define Y_axis_Value_MIN                           0
#define Y_axis_Value_MAX                           2000
#define Z_axis_Value_RATIO                         1
#define Z_axis_Value_ADDITION                      -1000
#define Z_axis_Value_MIN                           0
#define Z_axis_Value_MAX                           2000
#define Pressure_Value_RATIO                         1
#define Pressure_Value_ADDITION                      0
#define Pressure_Value_MIN                           0
#define Pressure_Value_MAX                           1000
/**@} */
...
typedef struct {
  bool valueLed_Value;
  bool valueMotor_Value;
  uint32_t valueHeartRateValue;
  int32_t valueX_axis_Value;
  int32_t valueY_axis_Value;
  int32_t valueZ_axis_Value;
  uint32_t valuePressure_Value;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagLed_Value:1;
  uint8_t flagMotor_Value:1;
} attrFlags_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueHeartRateValue;
  uint16_t valueX_axis_Value;
  uint16_t valueY_axis_Value;
  uint16_t valueZ_axis_Value;
  uint16_t valuePressure_Value;
} devStatus_t; 
